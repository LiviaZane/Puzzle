...
//		btn3.setEnabled(true);
		MementoTablaPuzzle memento = new MementoTablaPuzzle(tablaPuzzle.getTabla(), tablaPuzzle.getDim_puzzle());
		MementoCreate.CreateXML(memento);
		JOptionPane.showMessageDialog(frame, "Jocul a fost salvat in fisier pe disc.");
		btn3.setEnabled(true);
